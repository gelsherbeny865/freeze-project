...
if(isset($_POST['desc'])){
 ...
 $res =$obj1->updateproducts($desc,$title,$name,$pro_id);
if($res== true){
 ...
 $pro_id= $_GET['proid'];
$data=$obj1->getselectproductsbyid($pro_id);
}
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="selectproducts.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Show Products</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="updateproducts.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p> Update Products</p>
                </a>
              </li>
    ...
    <section class="content">
      ...
      <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Enter Products </h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="updateproducts.php" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Title</label>
                    <input type="text" class="form-control" name="title" id="exampleInputEmail1" placeholder="Enter Title" value="<?= $data['title'];?>">
                  </div>
                  <div class="form-group">
