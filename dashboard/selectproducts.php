              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <td><?= $d['description'];?> </td>
                    <td><?= $d['name'];?></td>
                    <td> <img src="upload/<?= $d['img'];?>"></td>
                    <td> <a href="updateproducts.php?proid=<?= $d['id']?>" class="btn btn-primary">Update</a></td>
                    <td><a href="deleteproducts.php?proid=<?=$d['id']?>" class="btn btn-primary">Delete</a></td>
                  </tr>
                  <?php endforeach;?>
                  </tbody>
                  <tfoot>
